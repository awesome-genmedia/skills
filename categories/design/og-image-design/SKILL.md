...
curl -X POST https://eachsense-agent.core.eachlabs.run/v1/chat/completions \
  ...
  -d '{
    "messages": [
      {
        "role": "user",
        "content": "Create an OG image background that matches this brand style. Same color palette and visual language, 1200x630 proportions, leave generous space for a large title on the left and a small logo area in the bottom right corner."
      }
    ],
