...
curl -X POST https://eachsense-agent.core.eachlabs.run/v1/chat/completions \
  ...
  -d '{
    "messages": [
      {
        "role": "user",
        "content": "Generate a cinematic game trailer clip based on this concept art. Bring the scene to life: add slow camera movement pushing forward, atmospheric particle effects, subtle character motion, and dramatic lighting. Cinematic widescreen format, game trailer quality."
      }
    ],
    "image_urls": ["https://example.com/game-concept-art.jpg"],
    "stream": false
  }'
```
